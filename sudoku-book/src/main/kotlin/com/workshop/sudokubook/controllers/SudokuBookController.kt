...
import com.workshop.sudokubook.collections.SolveSudokuRequest
...
class SudokuBookController(
    ...
    fun solveV1(@Validated @RequestBody req: SolveSudokuRequest): ResponseEntity<SudokuBookResponse> {
        sudokuBookService.create(req.filePath!!)
